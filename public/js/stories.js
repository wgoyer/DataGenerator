(function() {
  $(function() {
    return $('#storySubmit').on('click', function(e) {
      var data;
      $('#status').html('Loading...');
      data = {};
      $('#stories input, #stories select').each(function(i, item) {
      ...
      $.ajax({
        ...
        for (_i = 0, _len = results.length; _i < _len; _i++) {
          ...
          if (result.Object != null) {
            status += '<p class="text-success">Created story: ' + result.Object.FormattedID + '</p>';
          }
